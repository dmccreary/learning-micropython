...
To use projects you can load our [MicroPython Concepts](https://github.com/dmccreary/learning-micropython/blob/main/data/learning-micropython-concepts.csv) and [Glossary](../misc/glossary.md) into your project area.
