...
|---|---------|-------|--------|-------|
| 1 | Concepts | 485 | Required | Concepts from learning graph |
| 2 | Chapters | 23 | Required | Chapter directories with index.md |
| 3 | MicroSims | 27 | Recommended | Interactive simulations in docs/sims/ |
...
| 8 | FAQs | 78 | Recommended | Questions in faq.md |
| 9 | Words | 212,384 | Required | Words across student-facing markdown |
...
| Equations | 14 | 0 | LaTeX expressions (inline and display) |
| Total Words | 212,384 | 77,159 | Words in markdown files |
| Links | 1522 | 336 | Hyperlinks in markdown format |
| Equivalent Pages | 868 | 327 | Estimated pages (250 words/page + visuals) |
