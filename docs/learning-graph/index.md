# Learning Graph for Learning MicroPython
...
This learning graph contains **485 concepts** organized into **24 taxonomy categories**.
...
The graph has **913 dependency edges** and a maximum learning path length of **15 steps** — from *Computer Program* through to the *Mario Theme Program*.
...
- Foundational concepts: 1 entry point (Computer Program)
...
create 24 categories for our concepts and then place each concept
into a single primary classifier.

- A concept classifier taxonomy with 24 categories
- Category organization — foundational elements first, applied topics last
- All categories under 30% threshold (largest is APP at 8.5%)
- Clear 2–5 letter abbreviations for use in CSV file
