...
Putting all your hardware configuration information in a separate file is called [abstraction](../misc/glossary.md#abstraction) and it is one of the critical skills we use in [computational thinking](../misc/glossary.md#computational-thinking).