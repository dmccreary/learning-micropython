...
## Online Simulators
1. [Wokwi MicroPython Simulator](https://wokwi.com/micropython) - a free online simulator for running MicroPython on virtual Raspberry Pi Pico, ESP32, and other boards with simulated sensors and displays — no hardware required.
