...
**MicroSim:** concept-importance
**Repository:** learning-micropython
...
- **Detected subjects:** Mathematics, Computer Science, Chemistry, Biology, Statistics, Engineering
- **Visualization types:** animation, chart, graph, interactive-demo, network, map
- **Has main.html:** Yes
- **Has index.md:** Yes
