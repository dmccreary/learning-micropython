# MicroController Comparison Infographic Image Prompt

Instruction to the image model: Render all text exactly verbatim. Do not substitute any numbers, paraphrase labels, or invent extra rows/columns/stats. Where a cell says "None," render "None" — do not invent a wireless feature to fill it.
