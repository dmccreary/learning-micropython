---
title: GPIO Pin Functions on the Raspberry Pi Pico
description: An interactive reference to the seven GPIO functions on the Raspberry Pi Pico RP2040 — Digital I/O, PWM, ADC, I2C, SPI, and UART — with pins, MicroPython classes, and a quiz.
image: /posters/gpio-functions/pico-pin-infographic.png
og:image: /posters/gpio-functions/pico-pin-infographic.png
twitter:image: /posters/gpio-functions/pico-pin-infographic.png
social:
   cards: false
hide:
    toc
...
Reference card for all seven GPIO function types on the RP2040: Digital Output, Digital Input, PWM, ADC, I2C, SPI, and UART. Click each row to see available pins, MicroPython class, speed/resolution, and typical devices. Use Quiz Me to test when to reach for each function type.
