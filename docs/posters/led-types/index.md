---
title: LED Types Compared
description: An interactive comparison of single-color LEDs, RGB LEDs, NeoPixels (WS2812B), and 8×8 LED matrices — pins, control, and cost — with a built-in quiz.
image: /posters/led-types/led-types-infographic.png
og:image: /posters/led-types/led-types-infographic.png
twitter:image: /posters/led-types/led-types-infographic.png
social:
   cards: false
hide:
    toc
...
Compares four ways to add light to a project: the single-color LED, the RGB LED, the addressable NeoPixel (WS2812B), and the 8×8 LED matrix. Click each column to see pin counts, control methods, and costs, then use Quiz Me to test which LED type fits a given task.
