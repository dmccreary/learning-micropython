---
title: Memory Types in MicroPython
description: An interactive comparison of internal flash, SRAM, microSD cards, and I2C EEPROM — capacity, speed, volatility, and cost — with a built-in quiz.
image: /posters/memory-types/memeory-types-infographic.png
og:image: /posters/memory-types/memeory-types-infographic.png
twitter:image: /posters/memory-types/memeory-types-infographic.png
social:
   cards: false
hide:
    toc
---
# Memory Types in MicroPython
...
Compares the four places your data can live on a microcontroller: built-in flash, fast volatile SRAM, a large microSD card over SPI, and a tiny I2C EEPROM. Click each column to see capacity, speed, volatility, and cost, then use Quiz Me to decide which memory fits a given task.
