---
title: Common MicroPython Errors
description: An interactive reference to eight common MicroPython errors on the Raspberry Pi Pico — what each traceback means and how to fix it — with a built-in quiz.
image: /posters/micropython-errors/common-micropython-errors.png
og:image: /posters/micropython-errors/common-micropython-errors.png
twitter:image: /posters/micropython-errors/common-micropython-errors.png
social:
   cards: false
hide:
    toc
...
A quick-reference guide to eight common MicroPython errors you will meet on the Raspberry Pi Pico — MemoryError, OSError (ENOENT), OSError (ENODEV), ImportError, AttributeError, SyntaxError, TypeError, and ValueError. Click each error to see an example message, the cause, and the fix, then use Quiz Me to test whether you can name the error from its symptom.
