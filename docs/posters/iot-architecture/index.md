...
description: An interactive five-layer IoT reference architecture showing how data flows from a sensor on your desk up through the network, edge, and cloud to a dashboard, with a built-in quiz.
image: /posters/iot-architecture/iot-architecture-infographic.png
og:image: /posters/iot-architecture/iot-architecture-infographic.png
twitter:image: /posters/iot-architecture/iot-architecture-infographic.png
social:
   cards: false
hide:
    toc
...
Shows the five layers of a typical IoT system — Perception, Network, Edge Processing, Cloud Platform, and Application — and how data flows up from a sensor on your desk to a dashboard in the cloud while commands flow back down to your actuators. Click each layer to see its components and example technologies, then use Quiz Me to test which layer a given job belongs to.
