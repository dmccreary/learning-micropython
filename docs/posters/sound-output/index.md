---
title: Sound Output Methods Compared
description: An interactive comparison of passive buzzers, active buzzers, small speakers driven by PWM, and I2S DAC amplifier modules — sound generation, wiring, and cost — with a built-in quiz.
image: /posters/sound-output/sound-output-infographic.png
og:image: /posters/sound-output/sound-output-infographic.png
twitter:image: /posters/sound-output/sound-output-infographic.png
social:
   cards: false
hide:
    toc
