---
title: Robot Drive Configurations
description: An interactive comparison of five ways to build a mobile robot — differential drive, four-wheel drive, tricycle/Ackermann, mecanum, and quadruped — with a built-in quiz.
image: /posters/robot-configurations/robot-drive-configurations.png
og:image: /posters/robot-configurations/robot-drive-configurations.png
twitter:image: /posters/robot-configurations/robot-drive-configurations.png
social:
   cards: false
hide:
    toc
...
Compares five ways to build a mobile robot — differential drive (2WD), four-wheel drive (4WD), tricycle/Ackermann, mecanum/holonomic, and quadruped — each with different movement capabilities. Click each configuration to see its wheels, motor count, turning method, pros, cons, and best uses, then use Quiz Me to test which drive fits a given task.
