---
title: Motion & Light Sensors Compared
description: An interactive comparison of four sensors that let a MicroPython project sense the world around it — PIR motion, MPU-6050 accelerometer and gyroscope, LDR light sensor, and the APDS-9960 color, proximity, and gesture sensor — with a built-in quiz.
image: /posters/motion-light-sensors/motion-and-light-sensors-infographic.png
og:image: /posters/motion-light-sensors/motion-and-light-sensors-infographic.png
twitter:image: /posters/motion-light-sensors/motion-and-light-sensors-infographic.png
social:
   cards: false
hide:
    toc
...
Compares four sensors that let a project sense the world around it: the PIR motion sensor (HC-SR501), the MPU-6050 accelerometer and gyroscope, the LDR light sensor, and the APDS-9960 color, proximity, and gesture sensor. Click each column to see how it senses, how it connects, its range, and its cost, then use Quiz Me to test which sensor fits a given task.
