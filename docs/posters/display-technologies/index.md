---
title: Display Technologies Compared
description: An interactive comparison of OLED, TFT color LCD, and ePaper displays for MicroPython — resolution, color, power, and refresh speed — with a built-in quiz.
image: /posters/display-technologies/display-technologies-infographic.png
og:image: /posters/display-technologies/display-technologies-infographic.png
twitter:image: /posters/display-technologies/display-technologies-infographic.png
social:
   cards: false
hide:
    toc
...
Compares the three display families used with MicroPython: the OLED (tiny, low-power, monochrome), the TFT color LCD (full-color graphics), and ePaper/E-Ink (paper-like, zero static power). Click each column to compare resolution, power, and refresh speed, then use Quiz Me to test which screen fits a given project.
