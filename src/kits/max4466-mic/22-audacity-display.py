...
NOISE_FLOOR = 50        # Minimal noise level to ignore
...
try:
    ...
    # Set baseline as the average reading for the calibration period
    # This will be used to center the waveform
    # and to adjust the display scaling
