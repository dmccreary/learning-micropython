...
MAX_FREQUENCY = SAMPLE_RATE / 2  # Nyquist frequency (max measurable frequency)
...
def find_peak_frequency(magnitudes):
    ...
    for i in range(start_bin, len(magnitudes)):
...
try:
    ...
    print(f"Maximum Frequency: {MAX_FREQUENCY} Hz (Nyquist frequency)")
