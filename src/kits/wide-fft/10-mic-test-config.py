...
# read the hardware configuration from the config.py file
I2S_SCK_PIN = config.I2S_SCK_PIN # Serial Clock
I2S_WS_PIN = config.I2S_WS_PIN   # Word Select
I2S_SD_PIN = config.I2S_SD_PIN   # Serial Data
